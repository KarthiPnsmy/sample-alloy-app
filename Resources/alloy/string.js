exports.trim = function(line) {
...
}, exports.formatCurrency = String.formatCurrency, exports.urlDecode = function(string) {
    ...
    for (var n = 0; n < queryarr.length; ++n) {
        ...
        e < 0 ? (name = item, value = null) : (name = item.substring(0, e), value = item.substring(e + 1)), list[name] = value;
    }
    return ret.url = arr[0], ret.query = list, ret;
};